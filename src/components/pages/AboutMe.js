    ...
    <div className='container mt-5 mb-5'>
      ...
      <div className='container d-flex'>
        ...
        <p className='mt-4'>
          ...
          <br></br>
          <br></br>
          With 8 years of previous experience in real estate team management, business operations, and programming for non-profits, I have a wealth of input in conversations about leading teams and the strategy behind prioritizing team efforts for maximal returns. For further information on my previous experience, please visit my resume.
          <br></br>
          <br></br>
