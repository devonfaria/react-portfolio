...
const ProjectCard = (props) => {
  return (
    <div key={props.id} className="card col-lg-6 col-md-12 shadow p-3 mb-5 rounded">
      <a href={props.link} className='link' target="_blank" rel='noreferrer noopener'>
        <img className='card-img-top' src={props.imgLink}></img>
      </a>
      <h3 className="project-header mb-4">
        <a href={props.link} className='link' target="_blank" rel='noreferrer noopener'>{props.title}</a>
      </h3>
